...
function poolCanvasRenderer(canvas, cfg) {
  ...
  function frame() {
    ...
    // 5. Sandfilter cx=567
    ctx.beginPath(); ctx.ellipse(567,207,34,11,0,0,Math.PI*2); ctx.fillStyle="#152a1e"; ctx.fill(); ctx.strokeStyle="#1a5530"; ctx.lineWidth=1.2; ctx.stroke();
    rr(533,122,68,85,0); ctx.fillStyle="#162a1e"; ctx.fill(); ctx.strokeStyle="#1d5535"; ctx.lineWidth=1.5; ctx.stroke();
    ctx.beginPath(); ctx.ellipse(567,122,34,11,0,Math.PI,0); ctx.fillStyle="#1a3025"; ctx.fill(); ctx.strokeStyle="#256640"; ctx.lineWidth=1.5; ctx.stroke();
    rr(537,168,60,39,0); ctx.fillStyle="#1e3828"; ctx.fill();
    if (cfg.showPres) {
