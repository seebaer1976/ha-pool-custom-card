    ...
    if (!this.content) {
      ...
      this.innerHTML = `
        ...
        <svg viewBox="0 0 680 370">
          ...
          <!-- SANDFILTER -->
          <ellipse cx="568" cy="234" rx="34" ry="11" fill="#152a1e" stroke="#1a5530" stroke-width="1.2"/>
          <path d="M534 160 L534 234 Q534 245 568 245 Q602 245 602 234 L602 160" fill="#162a1e" stroke="#1d5535" stroke-width="1.5"/>
          <path d="M534 160 Q534 124 568 124 Q602 124 602 160" fill="#1a3025" stroke="#256640" stroke-width="1.5"/>
          <path d="M534 160 L534 234 Q534 245 568 245 Q602 245 602 234 L602 160 Q602 124 568 124 Q534 124 534 160" fill="none" stroke="#22dd66" stroke-width="0.6" opacity="0.5"/>
          <path d="M538 206 L538 232 Q538 243 568 243 Q598 243 598 232 L598 206 Z" fill="#1e3828" opacity="0.8"/>
          <path d="M538 190 Q568 200 598 190 L598 206 Q568 216 538 206 Z" fill="#254030" opacity="0.6"/>
          <circle cx="568" cy="170" r="24" fill="#0d1a12" stroke="#1d6633" stroke-width="1.5"/>
          <circle cx="568" cy="170" r="20" fill="none" stroke="#154422" stroke-width="1"/>
          <text x="568" y="165" text-anchor="middle" font-family="sans-serif" font-size="9" fill="#44bb77">bar</text>
          <text x="568" y="180" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="700" fill="#22dd66" id="pcc-pres">—</text>

          <!-- VENTIL -->
          <rect x="550" y="96" width="36" height="26" rx="4" fill="#1e3a28" stroke="#2a7040" stroke-width="1.5"/>
          <rect x="530" y="103" width="20" height="10" rx="3" fill="#1a3020" stroke="#22aa44" stroke-width="1.5"/>
          <circle cx="530" cy="108" r="4" fill="#0d1a10" stroke="#22dd66" stroke-width="1.2"/>
          <rect x="586" y="103" width="20" height="10" rx="3" fill="#0d1e30" stroke="#2266aa" stroke-width="1.5"/>
          <circle cx="606" cy="108" r="4" fill="#0a1520" stroke="#2288cc" stroke-width="1.2"/>
          <rect x="562" y="82" width="10" height="16" rx="3" fill="#2a4a35" stroke="#3a8a50" stroke-width="1.2"/>
          <ellipse cx="567" cy="82" rx="7" ry="3.5" fill="#2a5535" stroke="#4aaa60" stroke-width="1"/>
          <line x1="567" y1="79" x2="556" y2="68" stroke="#4aaa60" stroke-width="2.5" stroke-linecap="round"/>
          <circle cx="554" cy="67" r="3.5" fill="#22aa44" stroke="#44cc66" stroke-width="1"/>
          <rect x="562" y="122" width="10" height="14" rx="2" fill="#1e3a28" stroke="#2a6a3a" stroke-width="1"/>

          <!-- PUMPE -->
          <rect x="608" y="272" width="56" height="36" rx="6" fill="#1a1e30" stroke="#334488" stroke-width="1.5"/>
          <ellipse cx="630" cy="290" rx="15" ry="15" fill="#0f1525" stroke="#2244aa" stroke-width="1.5"/>
          <ellipse cx="630" cy="290" rx="9" ry="9" fill="#0a0f1e" stroke="#3366cc" stroke-width="1"/>
          <ellipse cx="630" cy="290" rx="3.5" ry="3.5" fill="#1a2a4a" stroke="#4488ff" stroke-width="1"/>
          <line x1="630" y1="282" x2="630" y2="298" stroke="#4488ff" stroke-width="1.2" opacity="0.6"/>
          <line x1="622" y1="290" x2="638" y2="290" stroke="#4488ff" stroke-width="1.2" opacity="0.6"/>
          <rect x="653" y="276" width="20" height="26" rx="4" fill="#161a28" stroke="#2a3060" stroke-width="1.2"/>
          <line x1="657" y1="276" x2="657" y2="302" stroke="#2a3060" stroke-width="1"/>
          <line x1="661" y1="276" x2="661" y2="302" stroke="#2a3060" stroke-width="1"/>
          <line x1="665" y1="276" x2="665" y2="302" stroke="#2a3060" stroke-width="1"/>
          <rect x="625" y="256" width="10" height="17" rx="3" fill="#141828" stroke="#2244aa" stroke-width="1.2"/>
          <rect x="586" y="284" width="22" height="10" rx="3" fill="#141828" stroke="#2244aa" stroke-width="1.2"/>
          <ellipse cx="630" cy="290" rx="16" ry="16" fill="none" stroke="#4488ff" stroke-width="0.5" opacity="0.4"/>
          <circle cx="658" cy="305" r="3" fill="#223" stroke="#334" id="pcc-led"/>

          <!-- ROHRLEITUNGEN blau statisch -->
          <path d="M346 268 C450 285 530 285 586 289" fill="none" stroke="#0d2a44" stroke-width="5" stroke-linecap="round"/>
          <path d="M346 268 C450 285 530 285 586 289" fill="none" stroke="#1a4a6a" stroke-width="3" stroke-linecap="round"/>
          <path d="M630 256 C628 200 620 150 606 108" fill="none" stroke="#0d2a44" stroke-width="5" stroke-linecap="round"/>
          <path d="M630 256 C628 200 620 150 606 108" fill="none" stroke="#1a4a6a" stroke-width="3" stroke-linecap="round"/>

          <!-- GRÜNE LINIEN statisch -->
          <!-- Seg1: Pool (331,185) → linker Anschluss Chlor (379,168) [getauscht] -->
          <path d="M331 185 C348 180 362 173 379 168" fill="none" stroke="#0a2018" stroke-width="5" stroke-linecap="round"/>
          <path d="M331 185 C348 180 362 173 379 168" fill="none" stroke="#1a4028" stroke-width="3" stroke-linecap="round"/>
          <!-- Seg2: rechter Anschluss Chlor (451,168) → Ventil links (530,108) [getauscht] -->
          <path d="M451 168 C480 148 505 128 530 108" fill="none" stroke="#0a2018" stroke-width="5" stroke-linecap="round"/>
          <path d="M451 168 C480 148 505 128 530 108" fill="none" stroke="#1a4028" stroke-width="3" stroke-linecap="round"/>

          <!-- GRÜNE LINIEN animiert (bwd = fließt von rechts nach links) -->
          <path id="pcc-p1"  d="M346 268 C450 285 530 285 586 289" fill="none" stroke="#2299ee" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="8 6" style="display:none"/>
          <path id="pcc-p2"  d="M630 256 C628 200 620 150 606 108" fill="none" stroke="#2299ee" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="8 6" style="display:none"/>
          <path id="pcc-p3a" d="M331 185 C348 180 362 173 379 168" fill="none" stroke="#22dd66" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="8 6" style="display:none"/>
          <path id="pcc-p3b" d="M451 168 C480 148 505 128 530 108" fill="none" stroke="#22dd66" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="8 6" style="display:none"/>

          <!-- CHLORINATOR -->
          <rect x="378" y="158" width="74" height="24" rx="12" fill="#d8d8d8" stroke="#aaaaaa" stroke-width="1.2"/>
          <path d="M383 158 Q383 133 415 131 Q447 129 447 158 Z" fill="#d2d2d2" stroke="#aaaaaa" stroke-width="1.2"/>
          <rect x="393" y="135" width="44" height="23" rx="9" fill="#2a3828" stroke="#3a5040" stroke-width="1.2"/>
          <rect x="397" y="138" width="13" height="7" rx="2" fill="#0a1208" stroke="#1a2a18" stroke-width="0.5"/>
          <circle cx="407" cy="142" r="3" id="pcc-chlor-led" fill="#001800" stroke="#002800"/>
          <circle cx="418" cy="141" r="1.8" fill="#3a5038"/>
          <circle cx="425" cy="141" r="1.8" fill="#3a5038"/>
          <circle cx="432" cy="141" r="1.8" fill="#3a5038"/>
          <circle cx="418" cy="149" r="1.8" fill="#3a5038"/>
          <circle cx="425" cy="149" r="1.8" fill="#3a5038"/>
          <circle cx="432" cy="149" r="1.8" fill="#3a5038"/>
          <!-- Rechter Anschluss x=451 -->
          <rect x="445" y="162" width="12" height="12" rx="3" fill="#888" stroke="#666" stroke-width="1"/>
          <ellipse cx="451" cy="168" rx="5" ry="5" fill="#1a2030" stroke="#4466aa" stroke-width="1.5"/>
          <ellipse cx="451" cy="168" rx="2.8" ry="2.8" fill="#0a1020" stroke="#5588cc" stroke-width="1"/>
          <!-- Linker Anschluss x=379 -->
          <rect x="373" y="162" width="12" height="12" rx="3" fill="#888" stroke="#666" stroke-width="1"/>
          <ellipse cx="379" cy="168" rx="5" ry="5" fill="#1a2030" stroke="#4466aa" stroke-width="1.5"/>
          <ellipse cx="379" cy="168" rx="2.8" ry="2.8" fill="#0a1020" stroke="#5588cc" stroke-width="1"/>

          <!-- Durchfluss Badge auf Seg2 -->
          <rect x="462" y="126" width="50" height="26" rx="6" fill="#0d1a12" stroke="#22aa44" stroke-width="1.2"/>
          <text x="487" y="137" text-anchor="middle" font-family="sans-serif" font-size="9" fill="#44bb77">m³/h</text>
          <text x="487" y="148" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" fill="#22dd66" id="pcc-flow">—</text>
        </svg>`;
